...
const firebaseConfig = {
  apiKey: "AIzaSyC7N3IOa7GRETNRBo8P-QKVFzg2bLqoEco", // Placeholder/Unknown key for 'iic-nst'
  ...
  messagingSenderId: "128267767708", // Might be incorrect but keeping format
  appId: "1:128267767708:web:08ed73b1563b2f3eb60259" // Might be incorrect
};

// --- 2. Initialization ---
const app = initializeApp(firebaseConfig);
// Analytics might fail if config is wrong, so optional handling or keeping it.
